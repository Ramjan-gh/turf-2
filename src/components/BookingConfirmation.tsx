  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative bg-white rounded-3xl max-w-3xl w-full shadow-2xl print:rounded-none print:shadow-none print:max-w-full"
      >
        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 w-10 h-10 bg-gray-100 hover:bg-gray-200 rounded-full flex items-center justify-center transition-colors z-10 print:hidden"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="p-8 print:p-12">
          ...
          <div className="text-center mb-6 print:hidden">
            ...
            <motion.h1
              ...
              className="mb-2 bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent"
            >
              Booking Confirmed!
            </motion.h1>
            <motion.p

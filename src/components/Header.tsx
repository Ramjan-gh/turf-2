...
import { Menu, User as UserIcon, Home, LogOut, Info, Mail, Image, Search } from 'lucide-react';
            ...
            {currentUser ? (
              ...
              >
                <Button
                  ...
                  className="bg-gradient-to-r from-purple-600 via-pink-600 to-orange-600  text-white border-0 shadow-lg"
                >
                  Login / Register
                </Button>
              </motion.div>
